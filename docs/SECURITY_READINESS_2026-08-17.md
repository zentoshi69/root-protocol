...
**Reviewed source:** protected default branch `claude/hoodpup-bitcoin-escrow-v1hll3` after the
security-readiness and dependency-alert pull requests (#9 and #23)
